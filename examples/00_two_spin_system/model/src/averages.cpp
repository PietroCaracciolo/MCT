...
void initializeAverages( AveragesStruct &averages,       
  ...
  if (parameters._save_m) {
    averages._average_m = 0;
  }
...
void updateAverages(AveragesStruct &averages,
  ...
  if (parameters._save_m) {
    averages._average_m += averages._average_m + (state._spin_config[0] + state._spin_config[1]);  
  }
...
void saveAverages(AveragesStruct &averages,
  ...
  if (parameters._save_m) {
    utils::saveScalarAverageToFile(average_output + "average_magnetization.txt", 
                            averages._average_m,
                            T,
                            mcs_av,
                           "saveAverageMagnetization");    
  }
...
void createFiles(ModelParametersStruct& parameters,
  ...
  if (parameters._save_E4) {
    ...
    if (parameters._save_m) {
       utils::createFile(average_output + "average_magnetization.txt", "saveAverageMagnetization");     
  }
